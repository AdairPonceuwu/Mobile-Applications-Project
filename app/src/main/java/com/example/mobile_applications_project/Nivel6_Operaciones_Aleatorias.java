...
public class Nivel6_Operaciones_Aleatorias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel6_operaciones_aleatorias);
    ...
    private void informacionDelJugador(){
        if (mUser != null){
            ...
            Toast.makeText(Nivel6_Operaciones_Aleatorias.this,"",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void Comparar(View view){
        ...
        if (!respuesta.equals("")){
            ...
            Toast.makeText(Nivel6_Operaciones_Aleatorias.this, "Debes escribir una respuesta", Toast.LENGTH_SHORT).show();
        }
    }
