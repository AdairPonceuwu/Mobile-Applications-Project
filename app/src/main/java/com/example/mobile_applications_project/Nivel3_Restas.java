...
public class Nivel3_Restas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel3_restas);
        ...
        Toast.makeText(this, "Ahora vamos con las restas", Toast.LENGTH_SHORT).show();
    ...
    private void informacionDelJugador(){
        if (mUser != null){
            ...
            Toast.makeText(Nivel3_Restas.this,"",Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if (!respuesta.equals("")){
            ...
            if(resultado == respuesta_jugador){
                ...
                switch (vidas){
                    ...
                    case 2:
                        Toast.makeText(Nivel3_Restas.this, "Te quedan dos vidas", Toast.LENGTH_SHORT).show();
                        imagenVidas.setImageResource(R.drawable.vida2);
                        break;

                    case 1:
                        Toast.makeText(Nivel3_Restas.this, "Te quedan una vida", Toast.LENGTH_SHORT).show();
                        imagenVidas.setImageResource(R.drawable.vida1);
                        break;
                    case 0:
                        Toast.makeText(Nivel3_Restas.this, "Has perdido todas tus vidas", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Nivel3_Restas.this, "Debes escribir una respuesta", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void NumAleatorio() {
        if(score <= 29){
            ...
            Intent intent = new Intent(this, Nivel4_Sumas_y_Restas.class);
