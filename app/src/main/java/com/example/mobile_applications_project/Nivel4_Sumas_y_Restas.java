...
public class Nivel4_Sumas_y_Restas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel4_sumas_yrestas);
        ...
        Toast.makeText(this, "Ahora vamos con sumas y restas", Toast.LENGTH_SHORT).show();
    ...
    private void informacionDelJugador(){
        if (mUser != null){
            ...
            Toast.makeText(Nivel4_Sumas_y_Restas.this,"",Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if (!respuesta.equals("")){
            ...
            if(resultado == respuesta_jugador){
                ...
                switch (vidas){
                    ...
                    case 2:
                        Toast.makeText(Nivel4_Sumas_y_Restas.this, "Te quedan dos vidas", Toast.LENGTH_SHORT).show();
                        imagenVidas.setAnimation(R.raw.dos);
                        imagenVidas.playAnimation();
                        break;

                    case 1:
                        Toast.makeText(Nivel4_Sumas_y_Restas.this, "Te quedan una vida", Toast.LENGTH_SHORT).show();
                        imagenVidas.setAnimation(R.raw.uno);
                        imagenVidas.playAnimation();
                        break;
                    case 0:
                        Toast.makeText(Nivel4_Sumas_y_Restas.this, "Has perdido todas tus vidas", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Nivel4_Sumas_y_Restas.this, "Debes escribir una respuesta", Toast.LENGTH_SHORT).show();
        }
    }
